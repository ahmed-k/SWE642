...
public class SurveyServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (req.getParameter("reqStudentId")!= null) {
            ...
            StudentBean requestedStudent = survey.dao.StudentDAO.getStudentBean(id);
       ...
       HttpSession session = req.getSession();
        ...
        //requested a particular student
            ...
            try {
                ...
                try {
                    survey.dao.StudentDAO.saveStudentBean(newBean);
                    String[] raffle = params.get("raffle");
                    survey.domain.DataBean dataBean = DataProcessor.produceDataBean(raffle);
                    session.setAttribute("dataBean", dataBean);

                    //get all Student IDs
                    List<String> studentIDs = survey.dao.StudentDAO.getAllStudentIDs();
